          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div className="min-w-0">
              ...
              <input
                ...
                className="w-full min-w-0 rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:border-[#0C71C3] focus:outline-none focus:ring-1 focus:ring-[#0C71C3] sm:px-4 sm:text-base"
              />
            </div>
